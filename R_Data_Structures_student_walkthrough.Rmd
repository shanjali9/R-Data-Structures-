...
first_matrix <- matrix(first_vector, nrow = 3, ncol = 3)
second_matrix <- matrix(second_vector, nrow = 3, ncol = 3)

array_of_matrices <- array(c(first_matrix, second_matrix), dim = c(3, 3, 2))
...
2.  In the above matrix that you created, print the value 5 by indexing in to the matrix.
    ...
    ```{r}
    print(array_of_matrices[2, 2, 1])

    print(array_of_matrices[3, 3,2])
    ```

3.  Print the third row of the first matrix.

    ```{r}
    print(array_of_matrices[3, , 1])
    ```
